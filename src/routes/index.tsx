...
import lookCheat from "@/assets/nutrition-label.png.asset.json";
import lookPlan from "@/assets/three-container-system.png.asset.json";
import lookRecipe from "@/assets/miso-salmon-bowl.png.asset.json";
